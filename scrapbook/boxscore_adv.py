...
print (len(box_score_list_team), "box scores retrieved")
insert_bronze_extracts('adv-team-boxscore-wnba', json.dumps(box_score_list_team))
insert_bronze_extracts('adv-player-boxscore-wnba', json.dumps(box_score_list_player))
